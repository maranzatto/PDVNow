...
<template>
    <svg xmlns="http://www.w3.org/2000/svg" :width="props.width" :height="props.height" viewBox="0 0 24 24" fill="none">
        ...
        <path d="M7.5 4.5L16.5 9.5V13" :stroke="props.color" stroke-width="2" stroke-linecap="round"
            stroke-linejoin="round" />
        <path d="M6 12.3281L9 14" :stroke="props.color" stroke-width="2" stroke-linecap="round"
            stroke-linejoin="round" />
        <path d="M3 7L12 12M12 12L21 7M12 12V22" :stroke="props.color" stroke-width="2" stroke-linejoin="round" />
    </svg>
</template>
