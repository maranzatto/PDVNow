...
<template>
    <svg :width="props.width" :height="props.height" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <circle cx="12" cy="5" r="3" :stroke="props.color" stroke-width="2" />
        <circle cx="4" cy="9" r="2" :stroke="props.color" stroke-width="2" />
        <circle cx="20" cy="9" r="2" :stroke="props.color" stroke-width="2" />
        <path
